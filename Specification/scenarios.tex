...
\scenario{Inspecting Last Commit}{scn:inspect_last_commit}
...
\scenario{Benchmark Post Failure}{scn:post_data_failure}
{CI: \Gls{benchmarking system}}
...
\scenario{Benchmark Fetch Failure}{scn:fetch_data_failure}
{Jeff: \Gls{user}}
