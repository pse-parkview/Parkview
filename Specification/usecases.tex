...
\case{Create Visualization}{cse:create_visualization}
{initated by User}
{benchmark data for change is available}
{\begin{enumerate}
    \item The user selects a set of changes.
...
\implementedby{scn:inspect_last_change}{cse:create_visualization}
\implementedby{scn:comp_benchmarks}{cse:create_visualization}
