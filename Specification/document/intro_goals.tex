...
\criterium{Generation of plots from benchmark results}
{crt:vis}
...
{The comparison between \glspl{benchmark configuration} is limited to only combinations of \glspl{benchmark configuration} that share the same benchmark type.}
