...
\teststep{User has the application open and no commits selected. The database contains \glspl{benchmark result}}
...
\teststep{User has two commits selected and the configuration panel open}
{User adjusts the configuration}
{Configuration gets updated on screen}

\teststep{User has two commits selected and the configuration panel open and has it configured}
...
\teststep{User has commits selected and the application with the configuration panel open. Configuration has been changed from the default.}
...
\teststep{User has the application with a \gls{plot} open}
