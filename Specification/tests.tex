...
\teststep{User has the web app open and no commits selected. The database contains benchmark data}
...
\teststep{User has commits selected and the web app with the configuration popup open. Configuration has been committed from the default.}
