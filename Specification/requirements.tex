...
\productData{Visualization Configuration}{pdt:vis_config}
Format: JSON \par

\productData{Visualization Types}{pdt:vis_types}

\productData{Visualization URLs for sharing}{pdt:vis_url}
