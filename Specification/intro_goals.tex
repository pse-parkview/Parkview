...
\criterium{Generation of visualizations from benchmark data}
{crt:vis}
...
\criterium{Robustness against errors}
{crt:error}
{The system can handle malformed input data and invalid requests.}

\subsection{Optional}

\criteriumOptional{Export and Sharing of visualizations}
...
\criteriumNot{Visualization types are predefined}
